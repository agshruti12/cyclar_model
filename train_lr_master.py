...
def train_and_export(
    ...
    id_cols: Tuple[str, ...] = ("id", "frame_id", "timestamp", "video", "frame", "fps", "side"),
    test_size: float = 0.2,
    random_state: int = 42,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--csv", default="master_features_labelled.csv", help="Merged labelled master CSV")
    parser.add_argument("--out", default="risk_lr_artifact.json", help="Output artifact JSON path")
    parser.add_argument("--label_col", default="danger_label", help="Name of the label column")
    args = parser.parse_args()

    train_and_export(
        features_csv=args.csv,
        out_artifact_json=args.out,
